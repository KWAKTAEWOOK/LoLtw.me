      ...
      slots: [
        {
          runes: [
            ...
            },
            {
              ...
              longDesc:
                "장화에 '<font color='#c60300'>포식자</font>' 사용 효과를 부여합니다.<br><br>전투 중이 아닐 때 1.5초 동안 정신 집중을 한 후 15초 동안 이동 속도가 45% 상승합니다. 공격 또는 스킬로 피해를 가하면 이 효과가 종료되며 60 ~ 180 (+추가 공격력의 <scaleAD>0.4</scaleAD>)(+주문력의 <scaleAP>0.25</scaleAP>)만큼 추가 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_AdaptiveDmg'><font color='#48C4B7'>적응형 피해</font></lol-uikit-tooltipped-keyword>를 줍니다.<br><br>재사용 대기시간: 150 ~ 100초. 게임 시작 시 재사용 대기 상태이며 정신 집중을 방해받으면 50%의 재사용 대기시간이 적용됩니다.",
            },
            {
              id: 8128,
              key: "DarkHarvest",
            ...
            },
            {
              ...
              name: "칼날비",
              shortDesc:
                "적 챔피언에 대한 첫 공격 3회 동안 공격 속도 대폭 증가",
              longDesc:
                "적 챔피언에 대한 3번째 공격까지 공격 속도가 110% 증가합니다.<br><br>3초 안에 다음 공격을 가하지 못하면 효과가 사라집니다.<br><br>재사용 대기시간: 적 챔피언과의 전투에서 벗어나면 8초의 재사용 대기시간이 적용됩니다.<br><br><rules>기본 공격 모션이 취소될 경우 공격 속도 증가 효과가 적용되는 공격 횟수가 1회 늘어납니다.<br>일시적으로 최고 공격 속도 제한을 초과할 수 있습니다.</rules>",
            },
          ],
        },
        {
          runes: [
            ...
            },
            {
              ...
              longDesc:
                "적 챔피언에게 피해를 입히면 체력을 회복합니다.<br><br>회복량: 18 ~ 35 (+추가 공격력의 0.2, +주문력의 0.1) (레벨에 비례)<br><br>재사용 대기시간: 20초",
            },
            {
              id: 8143,
              key: "SuddenImpact",
        ...
        },
        {
          runes: [
            ...
            },
            {
              ...
              name: "시야 수집",
              shortDesc:
                "챔피언 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Takedown'>처치 관여</lol-uikit-tooltipped-keyword> 시마다 감시 중첩 획득. 중첩당 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Adaptive'>적응형</lol-uikit-tooltipped-keyword>으로 공격력 또는 주문력 영구 증가 및 최대 중첩 도달 시 추가 증가",
              longDesc:
                "챔피언 처치에 관여하면 감시 중첩을 얻습니다. 감시 중첩 하나당 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Adaptive'><font color='#48C4B7'>적응형</font></lol-uikit-tooltipped-keyword>으로 추가 공격력 1.2 또는 추가 주문력 2의 효과를 얻습니다. <br><br>감시 중첩이 최대치인 10회에 도달하면 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Adaptive'><font color='#48C4B7'>적응형</font></lol-uikit-tooltipped-keyword>으로 추가 공격력 6 또는 추가 주문력 10의 효과를 부가적으로 획득합니다.<br><br>적 챔피언 처치 관여 시마다 감시 중첩 1회를 얻습니다.",
            },
          ],
        },
        {
          runes: [
            {
              ...
              name: "굶주린 사냥꾼",
              shortDesc:
                "적 챔피언당 <b>1회</b> 한정 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Takedown'>처치 관여</lol-uikit-tooltipped-keyword> 시 스킬 피해로 인한 체력 회복량 영구 증가 ",
              longDesc:
                "스킬로 입힌 피해량의 일부만큼 체력을 회복합니다.<br>체력 회복량: 1.5% + <i>현상금 사냥꾼</i> 중첩 1회당 2.5% <br><br>각 적 챔피언을 처치하는 데 처음으로 관여할 때마다 <i>현상금 사냥꾼</i> 중첩을 얻을 수 있습니다.<br><rules><br>광역 스킬의 경우 체력 회복 효과가 1/3로 감소합니다.</rules>",
            },
            {
              id: 8134,
              key: "IngeniousHunter",
              ...
              name: "영리한 사냥꾼",
              shortDesc:
                "적 챔피언당 <b>1회</b> 한정 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Takedown'>처치 관여</lol-uikit-tooltipped-keyword> 시 영구적으로 사용 아이템 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_CDR'>재사용 대기시간 감소</lol-uikit-tooltipped-keyword> (장신구 포함)",
              longDesc:
                "<b>사용 아이템 재사용 대기시간 감소</b> 효과를 15% + <i>현상금 사냥꾼</i> 중첩 1회당 5%만큼 얻습니다. (장신구 포함)<br><br>각 적 챔피언을 처치하는 데 처음으로 관여할 때마다 <i>현상금 사냥꾼</i> 중첩을 얻을 수 있습니다.",
            },
            {
              id: 8105,
              ...
              longDesc:
                "<b>전투에서 벗어나 있을 때 이동 속도</b>가 10 + <i>현상금 사냥꾼</i> 중첩 1회당 9만큼 증가합니다.<br><br>각 적 챔피언을 처치하는 데 처음으로 관여할 때마다 <i>현상금 사냥꾼</i> 중첩을 얻을 수 있습니다.",
            },
            {
              id: 8106,
              key: "UltimateHunter",
              ...
              longDesc:
                "궁극기에 5%의 <b>재사용 대기시간 감소</b>효과가 적용되고 <i>현상금 사냥꾼</i> 중첩 1회당 4%씩 추가로 감소합니다.<br><br>각 적 챔피언을 처치하는 데 처음으로 관여할 때마다 <i>현상금 사냥꾼</i> 중첩을 얻을 수 있습니다.",
            },
          ],
        },
      ],
          ...
          runes: [
            {
              ...
              name: "빙결 강화",
              shortDesc:
                "적 챔피언에 대한 첫 공격 시 둔화 적용(유닛당 재사용 대기시간 적용). 사용 아이템으로 챔피언 둔화 시 잠시 동안 둔화 구역을 생성하는 빙결 광선 발사",
              longDesc:
                "적 챔피언을 기본 공격하면 2초 동안 둔화시킵니다. 둔화 효과는 지속시간 동안 강화됩니다.<li><i>원거리 공격</i>: 최대 30% ~ 40% 둔화</li> <li><i>근접 공격</i>: 최대 45% ~ 55% 둔화</li><br>사용 아이템으로 적 챔피언을 둔화시키면 빙결 광선을 발사해서 주변 지역을 5초 동안 얼립니다. 해당 범위의 모든 유닛은 60% 둔화됩니다.<br><br>재사용 대기시간: 유닛당 7 ~ 4초",
            },
            {
              id: 8360,
              ...
              longDesc:
                "장착한 소환사 주문을 한 번만 사용 가능한 새로운 소환사 주문으로 교환합니다. 이전에 쓰지 않은 새로운 소환사 주문으로 교환할 때마다 교환의 재사용 대기시간이 영구적으로 20초씩 감소합니다. (최초 교환의 재사용 대기시간: 4분) <br><br>첫 번째 교환은 6분부터 가능합니다. <br><rules><br>소환사 주문은 전투에서 벗어났을 때만 교환할 수 있습니다. <br>교환한 소환사 주문을 사용한 후 3번 더 교환해야 다시 첫 번째 소환사 주문을 선택할 수 있습니다. </rules>",
            },
            {
              id: 8358,
              key: "MasterKey",
          ...
          runes: [
            {
              ...
              name: "마법공학 점멸기",
              shortDesc:
                "점멸이 재사용 대기 중일 때 <i>마법공학 점멸</i>로 대체됨<br><br><i>마법공학 점멸</i>: 정신 집중 후 다른 지점으로 순간 이동",
              longDesc:
            ...
            },
            {
              ...
              longDesc:
                "게임 시작 12분 후 약간 신비한 장화 아이템을 얻습니다. 그 전까지는 신발류 아이템을 구매할 수 없습니다. 챔피언 처치에 관여할 때마다 장화 획득 시점이 45초씩 앞당겨집니다.<br><br>약간 신비한 장화 보유 시 이동 속도가 +10 증가합니다.",
            },
            {
              id: 8313,
              key: "PerfectTiming",
              ...
              longDesc:
                "게임 시작 시 초시계 키트 아이템을 받습니다. 이 아이템은 14분 후 완벽한 초시계 아이템으로 변합니다. 챔피언 처치 관여 시마다 이 시간이 120초 감소합니다.<br><br>완벽한 초시계 아이템은 단 한 번 사용할 수 있으며, 사용 시 2.5초간 경직 효과를 얻습니다.",
            },
          ],
        },
        {
          ...
          runes: [
            {
              ...
              name: "우주적 통찰력",
              shortDesc:
                "<lol-uikit-tooltipped-keyword key='LinkTooltip_Description_CDR'>재사용 대기시간 감소</lol-uikit-tooltipped-keyword> +5%<br>최대 재사용 대기시간 감소 +5%<br>소환사 주문 재사용 대기시간 감소 +5%<br>아이템 재사용 대기시간 감소 +5%",
              longDesc:
                "재사용 대기시간 감소 +5%<br>최대 재사용 대기시간 감소 +5%<br>소환사 주문 재사용 대기시간 감소 +5%<br>아이템 재사용 대기시간 감소 +5%",
            },
            {
              id: 8410,
              ...
              name: "쾌속 접근",
              shortDesc:
                "<lol-uikit-tooltipped-keyword key='LinkTooltip_Description_ImpairMov'>이동을 방해받은</lol-uikit-tooltipped-keyword> 근처 아군 챔피언 또는 자신이 이동 방해기를 맞힌 적에게 이동할 때 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_MS'>이동 속도</lol-uikit-tooltipped-keyword> 증가",
              longDesc:
                "적 챔피언에게 이동 방해기를 맞히고 해당 적에게 이동할 때, 또는 이동 방해기에 맞은 근처의 아군 챔피언에게 이동할 때 이동 속도가 15% 증가합니다. <br><br>범위: 1000",
            },
            {
              id: 8352,
              key: "TimeWarpTonic",
              ...
              longDesc:
                "물약이나 비스킷을 사용하면 체력이나 마나 회복량의 50%를 즉시 회복하지만, 해당 소모품에 짧은 재사용 대기시간이 적용됩니다. 또한 물약이나 비스킷의 효과가 지속되는 동안 이동 속도가 5% 증가합니다.<br><br>재사용 대기시간: 해당 소모품의 지속시간과 동일합니다.",
            },
          ],
        },
      ],
      ...
      slots: [
        {
          runes: [
            ...
            },
            {
              ...
              name: "치명적 속도",
              shortDesc:
                "챔피언에게 피해를 입히고 1.5초 후 치명적 속도 상태 돌입. 치명적 속도 상태에서는 공격 속도 대폭 증가 및 일시적으로 공격 속도 상한 초과 가능",
              longDesc:
                "적 챔피언에게 피해를 주고 1.5초 후, 3초 동안 레벨에 따라 공격 속도가 40~110% 증가합니다. 적 챔피언을 공격하면 효과 지속시간이 6초까지 증가합니다.<br><br>재사용 대기시간: 6초<br><br>치명적 속도 상태에서는 일시적으로 최고 공격 속도 제한을 초과할 수 있습니다.",
            },
            {
              id: 8021,
              key: "FleetFootwork",
              ...
              longDesc:
                "공격 또는 이동 시 충전 중첩이 쌓입니다. 중첩이 100회 쌓이면 충전 상태로 다음 공격을 할 수 있습니다.<br><br>충전 상태로 공격 시 3~60(+추가 공격력의 0.3, +주문력의 0.3)에 해당하는 체력이 회복되며 1초 동안 이동 속도가 20% 증가합니다.<br><br>원거리 챔피언의 경우 미니언으로부터 받는 회복 효과가 20%만 적용됩니다.",
            },
            {
              id: 8010,
              key: "Conqueror",
              ...
              name: "정복자",
              shortDesc:
                "적 챔피언 공격 시 적응형 능력치 중첩 획득. 10회 중첩 시 챔피언 대상 피해량의 일부만큼 체력 회복",
              longDesc:
                "적 챔피언에게 기본 공격 또는 스킬로 피해를 입히면 6초 동안 정복자 중첩을 2만큼 얻어 중첩마다 2~5의 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Adaptive'><font color='#48C4B7'>적응형 능력치</font></lol-uikit-tooltipped-keyword>를 얻습니다. 최대 10회까지 중첩됩니다. 원거리 챔피언은 기본 공격으로 중첩을 1만 획득할 수 있습니다.<br><br>최대로 중첩되면 챔피언에게 입힌 피해량의 15%만큼 체력을 회복합니다. (원거리 챔피언은 8%)",
            },
          ],
        },
        {
          runes: [
            {
              ...
              name: "과다치유",
              shortDesc:
                "자신의 체력을 초과한 체력 회복 효과가 보호막으로 전환",
              longDesc:
            ...
            },
            {
              ...
              name: "승전보",
              shortDesc:
                "챔피언 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Takedown'>처치 관여</lol-uikit-tooltipped-keyword> 시 잃은 체력의 12%를 회복하며 추가로 20골드 획득 ",
              longDesc:
            ...
            },
            {
              ...
              name: "침착",
              shortDesc: "처치 관여 시 마나 또는 기력 회복 및 최대치 증가 ",
              longDesc:
                "처치 관여 시 최대 마나 또는 기력의 20%를 회복하고 최대 마나를 100(최대 500)만큼, 최대 기력을 10(최대 50)만큼 증가시킵니다. ",
            },
          ],
        },
        {
          runes: [
            ...
            },
            {
              ...
              longDesc:
                "<i>전설</i> 중첩당 생명력 흡수가 0.6% 증가합니다. (<statGood>최대 전설 중첩 횟수: 20</statGood>)<br><br>챔피언 처치 관여, 에픽 몬스터 처치 관여, 대형 몬스터 처치, 미니언 처치 시마다 <i>전설</i> 중첩을 얻습니다.",
            },
          ],
        },
        {
          runes: [
            ...
            },
            {
              ...
              name: "체력차 극복",
              shortDesc:
                "적 최대 체력이 더 많을 경우 해당 챔피언에게 추가 피해",
              longDesc:
      ...
      slots: [
        {
          runes: [
            ...
            },
            {
              ...
              name: "수호자",
              shortDesc:
                "스킬 대상으로 지정한 아군과 가까운 아군을 보호. 자신 또는 보호받는 아군이 피해를 입으면 둘 다 이동 속도 증가 및 보호막 획득",
              longDesc:
                "자신으로부터 175유닛 내에 있는 아군이나 자신이 스킬의 대상으로 삼은 아군을 2.5초 동안 <i>보호</i>합니다. <i>보호</i>하는 중 자신과 아군 중 한 명이 피해를 입으면 둘 모두에게 보호막이 생성되며 이동 속도가 1.5초 동안 빨라집니다.<br><br>재사용 대기시간: <scaleLevel>70~40</scaleLevel>초<br>보호막 흡수량: <scaleLevel>70~150</scaleLevel> + 주문력의 <scaleAP>25%</scaleAP> + 추가 체력의 <scalehealth>12%</scalehealth><br>이동 속도 증가: +20%",
            },
          ],
        },
        {
          runes: [
            ...
            },
            {
              ...
              longDesc:
                "적 챔피언의 이동을 방해하면 4초 동안 표식을 남깁니다.<br><br>표식이 남겨진 적을 공격하는 아군 챔피언은 2초에 걸쳐 5 + 나의 최대 체력의 1%에 해당하는 체력을 회복합니다. ",
            },
            {
              id: 8401,
              key: "ShieldBash",
          ...
          runes: [
            {
              ...
              name: "사전 준비",
              shortDesc:
                "10분 후 방어력 +9 및 마법 저항력 +9 증가와 동시에 방어력 및 마법 저항력 5% 증가",
              longDesc:
                "10분 후 방어력 +9 및 마법 저항력 +9 증가와 동시에 방어력 및 마법 저항력 5% 증가",
            },
            {
        ...
        },
        {
          runes: [
            ...
            },
            {
              ...
              name: "소생",
              shortDesc:
                "자신이 사용하거나 받는 회복과 보호막의 효과 5% 강화. 체력이 낮은 대상에게는 효과가 10% 증가",
              longDesc:
                "자신이 사용하거나 받는 회복과 보호막 효과가 5% 강화됩니다. 체력이 40% 이하인 대상에게는 이 효과가 10% 증가합니다.",
            },
            {
              id: 8242,
              key: "Unflinching",
              ...
              name: "불굴의 의지",
              shortDesc:
                "소환사 주문을 사용한 후 잠시 동안 강인함 및 둔화 저항 증가. 또한 소환사 주문이 재사용 대기 상태가 될 때마다 강인함 및 둔화 저항 추가 증가 ",
              longDesc:
                "소환사 주문을 사용한 후 10초 동안 15%의 강인함 및 둔화 저항을 추가로 얻습니다. 또한 소환사 주문이 재사용 대기 상태가 될 때마다 강인함 및 둔화 저항이 10% 증가합니다. ",
            },
          ],
        },
      ],
      ...
      slots: [
        {
          runes: [
            ...
            },
            {
              ...
              longDesc:
                "4초 안에 한 챔피언에게 기본 공격 3회 또는 <b>개별</b> 스킬 3회를 적중시키면 레벨에 따라 25~40%의 이동 속도와 75%의 둔화 저항 효과를 얻습니다. <br><br>근접 챔피언의 경우 이동 속도가 30~50% 증가합니다.<br><br>지속시간: 3초<br>재사용 대기시간: 15초",
            },
          ],
        },
        {
          runes: [
            ...
            },
            {
              ...
              name: "빛의 망토",
              shortDesc:
                "소환사 주문 사용 후 잠시 동안 이동 속도 증가 및 유닛 통과 가능",
              longDesc:
                "소환사 주문 사용 후 2.5초 동안 이동 속도가 증가하며 유닛을 통과할 수 있습니다.<br><br>증가: 소환사 주문 재사용 대기시간에 따라 이동 속도가 15%~35% 증가합니다. (재사용 대기시간이 길수록 이동 속도가 더 많이 증가합니다.) ",
            },
          ],
        },
        {
          runes: [
            {
              ...
              name: "깨달음",
              shortDesc:
                "10레벨 도달 시 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_CDR'>재사용 대기시간 감소</lol-uikit-tooltipped-keyword> 10%. 재사용 대기시간 초과분은 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Adaptive'>적응형</lol-uikit-tooltipped-keyword>으로 주문력 또는 공격력으로 전환",
              longDesc:
                "10레벨에 도달하면 재사용 대기시간이 10% 감소합니다.<br><br>재사용 대기시간 감소 최대치 초과분 1%당 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Adaptive'><font color='#48C4B7'>적응형</font></lol-uikit-tooltipped-keyword>으로 추가 공격력 1.2 또는 추가 주문력 2 효과로 전환됩니다.",
            },
            {
              id: 8234,
              key: "Celerity",
              ...
              name: "기민함",
              shortDesc:
                "모든 추가 이동 속도 효과 7% 증가 및 이동 속도 1% 증가",
              longDesc:
                "모든 추가 이동 속도 효과가 7% 증가하고 1%의 추가 이동 속도를 얻습니다.",
            },
            {
              id: 8233,
              key: "AbsoluteFocus",
        ...
        },
        {
          runes: [
            ...
            },
            {
              ...
              longDesc:
                "강에 있을 때 이동 속도가 25 증가하고 레벨에 비례하여 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Adaptive'><font color='#48C4B7'>적응형</font></lol-uikit-tooltipped-keyword>으로 추가 공격력 최대 18 또는 추가 주문력 최대 30의 효과를 얻습니다.<br><br><hr><br><i>굽이치는 강물처럼 빠르고 깜짝 놀란 협곡 바위 게처럼 날렵하게 움직이리라.</i><br>",
            },
            {
              id: 8236,
              key: "GatheringStorm",
              ...
              name: "폭풍의 결집",
              shortDesc:
                "게임 중 아이템에 따라 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Adaptive'>적응형</lol-uikit-tooltipped-keyword> 공격력 또는 주문력 획득량 증가",
              longDesc:
